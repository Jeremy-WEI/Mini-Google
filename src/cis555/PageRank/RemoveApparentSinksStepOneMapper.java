...
public class RemoveApparentSinksStepOneMapper extends Mapper<LongWritable, Text, Text, Text> {
	...
	if (!linksStr.equals("")) {
	    ...
	    for (String target : linkCollection) {
		context.write(new Text(target), url);
	    }
	}
