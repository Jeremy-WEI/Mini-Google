...
public class RankServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        for (int i = 0; i < words.length; i++) {
        	docHitList.addAll(DocHitEntityIndexTermDBDAO.getDocHitEntities(words[i]));
        }
...
//         Set<DocHitEntity> lst3 = db.getDocHit("donor");
         ...
         for (DocHitEntity docHit : docHitList) {
        	 ...
        	 System.out.println(DocHitEntityIndexTermDBDAO.getUrl(docHit.getDocID()));
         }
//        lst1.retainAll(lst2);
...
//		TableKeysAndAttributes invertedIndexTable = new TableKeysAndAttributes("inverted-index");
...
//		
//		try {
//			BatchGetItemOutcome outcome = dynamoDB.batchGetItem(invertedIndexTable);
...
//		}		
	...
	public Double getPageRankFromDocId(long docID) {
		return 1.0;
//		TableKeysAndAttributes pageRankTable = new TableKeysAndAttributes("pagerank");
