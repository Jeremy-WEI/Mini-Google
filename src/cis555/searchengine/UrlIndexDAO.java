...
public class UrlIndexDAO {
     ...
     * 
     * @param docID
     *            The primary key for the UrlIndex.
     * @return The UrlIndex instance.
     */
    public static DocIdUrlInfo getDocIdUrlInfo(String docID) {
        return urlIndex.get(docID);
    }

    /**
     * Retrieve a URL from the database given its docID.
     * 
     * @param docID
     *            The primary key for the UrlIndex.
     * @return The URL for the given docID.
     */
    public static String getUrl(String docID) {
        DocIdUrlInfo docIdUrlInfo = getDocIdUrlInfo(docID);
