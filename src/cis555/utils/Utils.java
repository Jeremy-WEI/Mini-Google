...
public class Utils {
	...
	/**
	 * Hashes a url using MD5, and returns a Hex-string representation of the hash
	 * @param url
	 * @return
	 */
	...
	/**
	 * Append an array of bytes representing a byte array to the beginning of a file, of length set by CrawlerConstants.MAX_URL_LENGTH * 2 (since each character could be up to 2 bytes)
	 * Null characters will be appended to fill up the byte array
	 * @param url
	 * @param contents
	 * @return
	 */
